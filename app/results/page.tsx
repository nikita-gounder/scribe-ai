...
export default function ResultsPage() {
  ...
  return (
    <main className="min-h-screen bg-white px-6 py-8 text-slate-900 lg:px-10">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
        <header className="flex items-center justify-between rounded-[2rem] border border-slate-100 bg-white px-6 py-5 shadow-sm sm:px-8">
